...
- [4.2. Tactical-Level Domain-Driven Design](/chapter04.md#43-landing-page-ui-design)
    - [4.2.1. Domain Layer](/chapter04.md#431-landing-page-wireframe)
    - [4.2.2. Interface Layer](/chapter04.md#432-landing-page-mock-up)
    - [4.2.3. Application Layer](/chapter04.md#44-web-applications-uxui-design)
    - [4.2.4. Infrastructure Layer](/chapter04.md#441-web-applications-wireframes)
    - [4.2.5. Bounded Context Software Architecture Component Level Diagrams](/chapter04.md#442-web-applications-mock-ups)
    - [4.2.6. Bounded Context Software Architecture Code Level Diagrams](/chapter04.md#443-web-applications-user-flow-diagrams)
      - [4.2.6.1. Bounded Context Domain Layer Class Diagrams](/chapter04.md) 
      - [4.2.6.2. Bounded Context Database Design Diagram](/chapter04.md#45-web-applications-prototyping)
